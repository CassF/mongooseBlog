...
class AdminController {
  ...
  //     res.render("adminBlog/adminReply", {
  //       title: "Blog",
  //       blog: blog
  //     });
  //   })
  ...
  //   //or $set
  //   Blog.update({ _id: req.params.id,"comments.subject": req.body.subject }, { "comments.$.adminReply": { $push: { "reply": req.body.reply } } }, function (err, post) {
  //     if (err) return res.status(500).send(err);
  //     // redirect the user to a GET route. We'll go back to the INDEX.
